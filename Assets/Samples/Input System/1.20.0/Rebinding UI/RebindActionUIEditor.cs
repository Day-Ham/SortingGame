...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_RebindDuplicatePrompProperty = serializedObject.FindProperty("m_RebindDuplicatePromp");
            m_ConfirmSwapButtonProperty = serializedObject.FindProperty("m_ConfirmSwapButton");
            m_CancelSwapButtonProperty = serializedObject.FindProperty("m_CancelSwapButton");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_RebindDuplicatePrompProperty);
                EditorGUILayout.PropertyField(m_ConfirmSwapButtonProperty);
                EditorGUILayout.PropertyField(m_CancelSwapButtonProperty);
        ...
        private SerializedProperty m_RebindDuplicatePrompProperty;
        private SerializedProperty m_ConfirmSwapButtonProperty;
        private SerializedProperty m_CancelSwapButtonProperty;
